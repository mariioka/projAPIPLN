...
### Dataset
Este projeto utiliza um dataset contendo avaliações de clientes do 89ºC Coffee Station, coletadas a partir do Google Maps. O notebook realiza a análise exploratória e a preparação dos dados com o objetivo de extrair insights relevantes sobre a percepção dos clientes.
